...
<head>
    ...
    <title>Trucklink — Admin profile</title>
</head>
                    ...
                    <div id="admin_cargo" class="tabless">
                        ...
                        <div class="filterss aniEl">
                            ...
                            <div class="filter_search">
                                <input type="number" placeholder="Search ID" name="search_id" >
                            </div>
                        ...
                        <div class="admin_orders_table"></div>
                    </div>
                    <?php /*
